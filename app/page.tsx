    ...
    <main className="flex min-h-screen flex-col">
      ...
      <section className="relative h-[650px]">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-transparent flex flex-col items-start justify-center px-8 md:px-16 lg:px-24">
          <div className="max-w-2xl">
            ...
            <p className="text-lg md:text-xl max-w-xl mb-10 text-white/90 drop-shadow">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <Button
                asChild
                size="lg"
                className="bg-[#00457B] hover:bg-[#003b69] min-w-[200px] h-14 text-lg font-medium shadow-xl rounded-full transition-transform hover:scale-105"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="text-white border-white hover:bg-white/20 min-w-[200px] h-14 text-lg font-medium shadow-xl rounded-full transition-transform hover:scale-105"
              >
      ...
      <section className="py-0 -mt-20 relative z-10 mb-12">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
              <div className="stat-card bg-gradient-to-br from-[#00457B] to-[#005da3] text-white p-8 flex items-center transform transition-transform hover:scale-105">
                <div className="mr-6 bg-white/20 p-4 rounded-full">
                  <Calendar className="h-8 w-8" />
                </div>
                <div>
                  <div className="text-4xl font-bold mb-1">15+</div>
                  <div className="text-sm font-medium text-blue-100">Años de experiencia</div>
                </div>
              </div>

              <div className="stat-card bg-gradient-to-br from-[#005da3] to-[#0075cc] text-white p-8 flex items-center transform transition-transform hover:scale-105">
                <div className="mr-6 bg-white/20 p-4 rounded-full">
                  <Building2 className="h-8 w-8" />
                </div>
                <div>
                  <div className="text-4xl font-bold mb-1">500+</div>
                  <div className="text-sm font-medium text-blue-100">Propiedades vendidas</div>
                </div>
              </div>

              <div className="stat-card bg-gradient-to-br from-[#0075cc] to-[#008df5] text-white p-8 flex items-center transform transition-transform hover:scale-105">
                <div className="mr-6 bg-white/20 p-4 rounded-full">
                  <UserCheck className="h-8 w-8" />
                </div>
                <div>
                  <div className="text-4xl font-bold mb-1">300+</div>
                  <div className="text-sm font-medium text-blue-100">Clientes satisfechos</div>
                </div>
              </div>

              <div className="stat-card bg-gradient-to-br from-[#008df5] to-[#00a5ff] text-white p-8 flex items-center transform transition-transform hover:scale-105">
                <div className="mr-6 bg-white/20 p-4 rounded-full">
                  <Users className="h-8 w-8" />
                </div>
                <div>
                  <div className="text-4xl font-bold mb-1">50+</div>
                  <div className="text-sm font-medium text-blue-100">Agentes inmobiliarios</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {categories.map((category, index) => (
              <Link href={category.link} key={index}>
                <div className="group relative h-80 rounded-xl overflow-hidden shadow-xl transition-all duration-300 hover:shadow-2xl">
                  <Image
              ...
              {services.map((service, index) => (
                <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3 p-3">
                  <Card className="h-full border-none shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden group">
                    <div className="absolute top-0 left-0 w-2 h-full bg-[#00457B]"></div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center mb-16">
            ...
            <div className="mt-6 md:mt-0">
              ...
              >
                <Link href="/inmuebles" className="flex items-center gap-2">
            ...
            {properties.map((property, index) => (
              ...
              >
                ...
                <CardFooter>
                  ...
                  >
                    <Link href={`/inmuebles/${property.id}`} className="flex items-center justify-center gap-2">
                      Ver detalles
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="relative h-[500px] rounded-xl overflow-hidden shadow-2xl order-2 md:order-1">
              <Image src="/about-image.jpg" alt="Por qué elegirnos" fill className="object-cover" />
            ...
            <div className="order-1 md:order-2">
              <h2 className="text-3xl font-bold text-[#00457B] mb-6 relative inline-block">
                ¿Por qué elegirnos?
                <span className="absolute -bottom-2 left-0 w-20 h-1 bg-[#00457B]"></span>
              </h2>
              <p className="text-gray-600 mb-10 mt-6 text-lg">
              ...
              <div className="space-y-8">
                {whyChooseUs.map((item, index) => (
                  <div
                    key={index}
                    className="flex bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                  >
              ...
              <Button
                asChild
                className="mt-10 bg-[#00457B] hover:bg-[#003b69] rounded-full px-8 py-6 h-auto text-lg font-medium shadow-lg"
              >
      ...
      {/* Testimonials */}
      <section className="py-20 bg-[#00457B]/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-[#00457B] mb-4 relative inline-block">
          ...
          <Carousel className="w-full max-w-5xl mx-auto">
            <CarouselContent>
              {testimonials.map((testimonial, index) => (
                <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/1 p-4">
                  <Card className="h-full border-none shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden">
                    <CardContent className="p-8 relative">
                      <div className="text-[#00457B] text-6xl font-serif absolute top-4 left-6 opacity-20">"</div>
                      <div className="flex flex-col items-center text-center">
                        <div className="w-20 h-20 rounded-full overflow-hidden mb-6 border-4 border-[#00457B]/20">
                          <Image
                        ...
                        <div className="pt-4 border-t border-gray-200 w-16 mb-2"></div>
                        <p className="font-bold text-lg text-[#00457B]">{testimonial.name}</p>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-[#00457B]">
        <div className="container mx-auto px-4">
          <div className="bg-[url('/cta-pattern.png')] bg-cover bg-center bg-no-repeat rounded-2xl p-12 text-center text-white">
            ...
            <p className="max-w-2xl mx-auto mb-10 text-lg opacity-90">
              Nuestro equipo de expertos está listo para ayudarte a encontrar la propiedad perfecta para ti y tu
              familia. Contáctanos hoy mismo y comienza tu camino hacia el hogar de tus sueños.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-white text-white hover:bg-white hover:text-[#00457B] rounded-full px-8 py-6 h-auto text-lg font-medium shadow-lg"
              >
                <Link href="/contactanos" className="flex items-center gap-2">
              ...
              <Button
                asChild
                size="lg"
                className="bg-white text-[#00457B] hover:bg-gray-100 rounded-full px-8 py-6 h-auto text-lg font-medium shadow-lg"
              >
                <Link href="/inmuebles" className="flex items-center gap-2">
                  <Search className="h-5 w-5" />
                  Ver propiedades
...
const categories = [
  {
    title: "Casas",
    count: 124,
    image: "/category-houses.jpg",
    link: "/inmuebles?tipo=casa",
  },
  {
    title: "Apartamentos",
    count: 87,
    image: "/category-apartments.jpg",
    link: "/inmuebles?tipo=apartamento",
  },
  {
    title: "Oficinas",
    count: 53,
    image: "/category-offices.jpg",
    link: "/inmuebles?tipo=oficina",
  },
  {
    title: "Terrenos",
    count: 32,
    image: "/category-lands.jpg",
...
const services = [
  ...
  },
  {
    ...
    icon: <Users className="h-7 w-7 text-[#00457B]" />,
  },
]
