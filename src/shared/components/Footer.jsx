        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex justify-center md:justify-start mb-6">
              <img src="/matriz-logo-white.png" alt="Matriz Inmobiliaria" width={180} height={60} />
            </div>
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="hover:text-blue-300 transition-colors inline-block">
                  Inicio
                </Link>
              </li>
              <li>
                <Link to="/nosotros" className="hover:text-blue-300 transition-colors inline-block">
                  Nosotros
                </Link>
              </li>
              <li>
                <Link to="/inmuebles" className="hover:text-blue-300 transition-colors inline-block">
                  Inmuebles
                </Link>
              </li>
              <li>
                <Link to="/servicios" className="hover:text-blue-300 transition-colors inline-block">
                  Servicios
                </Link>
              </li>
              <li>
                <Link to="/contactanos" className="hover:text-blue-300 transition-colors inline-block">
                  Contáctanos
                </Link>
              </li>
              <li>
                <Link to="/blog" className="hover:text-blue-300 transition-colors inline-block">
                  Blog
                </Link>
              </li>
            </ul>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-4 md:mt-0">
              <Link to="/terminos-condiciones" className="text-sm text-gray-300 hover:text-white">
                Términos y Condiciones
              </Link>
              <Link to="/politica-privacidad" className="text-sm text-gray-300 hover:text-white">
                Política de Privacidad
              </Link>
              <Link to="/mapa-sitio" className="text-sm text-gray-300 hover:text-white">
                Mapa del Sitio
              </Link>
            </div>
          </div>
