  ...
  return (
    <main className="flex min-h-screen flex-col">
      ...
      <section className="relative h-[500px] overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-[#00457B] via-[#1e40af] to-[#3b82f6]" />
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#00457B] mb-6">Servicios Inmobiliarios Especializados</h2>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
            <h3 className="text-3xl font-bold text-[#00457B] mb-8 text-center">Servicios Adicionales</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {additionalServices.map((service, index) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#00457B] to-[#1e40af] flex items-center justify-center mx-auto mb-4">
                    {service.icon}
                  </div>
      ...
      {/* Process Section */}
      <section className="py-20 bg-gradient-to-r from-[#00457B] to-[#1e40af] text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {workProcess.map((step, index) => (
              <div key={index} className="text-center relative">
                ...
                <div className="relative">
                  <div className="w-16 h-16 rounded-full bg-white text-[#00457B] flex items-center justify-center text-2xl font-bold mx-auto mb-6 shadow-lg">
                    {index + 1}
                  </div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#00457B] mb-6">Preguntas Frecuentes</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            <Accordion type="single" collapsible className="w-full space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  <AccordionTrigger className="text-left font-semibold text-[#00457B] hover:text-[#1e40af] py-6">
                    {faq.question}
                  </AccordionTrigger>
      ...
      {/* Contact CTA */}
      <section className="py-20 bg-gradient-to-r from-[#00457B] via-[#1e40af] to-[#3b82f6] text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
                size="lg"
                className="bg-white text-[#00457B] hover:bg-gray-100 font-semibold px-8 py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
              >
                <Link to="/contacto">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-[#00457B] font-semibold px-8 py-4 rounded-2xl transition-all duration-300"
              >
                <Link to="/inmuebles">
