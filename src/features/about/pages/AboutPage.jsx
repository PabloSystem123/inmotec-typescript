  ...
  return (
    <main className="flex min-h-screen flex-col">
      ...
      <section className="relative h-[400px]">
        <img src="/about-hero.jpg" alt="Sobre Matriz Inmobiliaria" className="w-full h-full object-cover brightness-[0.65]" />
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#00457B] mb-6">Nuestra Historia</h2>
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl">
              <img src="/about-image.jpg" alt="Historia de Matriz Inmobiliaria" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#00457B] mb-4">Misión, Visión y Valores</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-none shadow-lg">
              <CardContent className="pt-6">
                <div className="w-12 h-12 rounded-full bg-[#00457B]/10 flex items-center justify-center mb-4 mx-auto">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#00457B] mb-4">Nuestro Equipo</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <div key={index} className="text-center">
                ...
                <p className="text-[#00457B] font-medium mb-2">{member.position}</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#00457B] mb-4">¿Por qué elegirnos?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {reasons.map((reason, index) => (
              <div key={index} className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-[#00457B]/10 flex items-center justify-center mb-4">
                  {reason.icon}
                </div>
